...
import { close, logoo, menu, Wallets } from "../assets";
  ...
  return (
    <nav className="w-full flex  py-6 justify-between items-center navbar">
      ...
      <ul className="list-none  sm:flex hidden justify-end items-center flex-1">
        ...
        <li className="text-dimWhite text-[16px] font-poppins  cursor-pointer" style={{ marginLeft: "35px" }} href="#" onClick={() => window.open(Pdf)}>
          WhitePaper
        </li>
