...
const Navbar = () => {
  ...
  const { web3, balance, contract, accounts, socketContract } = useAppSelector((state) => state.web3Connect);
  ...
  return (
    <nav className="w-full flex  py-6 justify-between items-center navbar">
      ...
      <ul className="list-none  sm:flex hidden justify-end items-center flex-1">
        ...
        <li className="text-dimWhite text-[16px] mr-4 font-poppins cursor-pointer" style={{ marginLeft: "35px" }}>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center cursor-pointer">
        ...
        >
          <ul className="list-none flex justify-end items-start flex-1 flex-col">
            ...
            <li className="text-dimWhite text-[16px] font-poppins cursor-pointer" style={{ marginTop: "20px" }}>
              <NavLink to="/accounts">Account</NavLink>
            </li>
